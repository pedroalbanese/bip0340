...
var (
	ErrPrivateKey         = errors.New("bip0340: invalid PrivateKey")
	ErrParametersNotSetUp = errors.New("bip0340: parameters not set up before generating key")
	ErrInvalidASN1        = errors.New("bip0340: invalid ASN.1")
	ErrInvalidSignerOpts  = errors.New("bip0340: opts must be *SignerOpts")
)
